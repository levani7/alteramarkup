        ...
        <table class="w-full border">
            ...
            {rows.map((_,index) => (
                <tr class="list bg-white text-center border-b">
                    ...
                    <td class="p-2 border-r text-[#377DFF] text-[16px] font-bold">პოზიციის დასახელება</td>
                    <td class="p-2 border-r text-[#333333] text-[16px] font-bold">კომპანია</td>
                    <td class="p-2 border-r text-[#333333] text-[16px] font-bold">დეპარტამენტი </td>
                    <td class="p-2 border-r text-[#333333] text-[16px] font-bold">50 000</td>
